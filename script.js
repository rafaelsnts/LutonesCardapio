  ...
  cart.forEach((item) => {
    ...
    cartItemElement.innerHTML = `
        <div class="flex justify-between items-center">
            ...
            <button class="remove-from-cart-btn bg-red-500 text-white px-2 py-1 rounded" data-name="${
              item.name
            }">
                Remover 
            </button>
...
checkoutBtn.addEventListener("click", function () {
  ...
  if (!isOpen) {
    Toastify({
      text: "Opsss... O restaurante esta fechado!! Horário de funcionamento: 18h às 22h.",
      duration: 3000,
      close: true,
      gravity: "top",
      position: "right",
  ...
  const phoneNumber = "5521976553394";
  window.open(
